...
The current ChromaDB release is pinned in `requirements.lock`. As of September 10, 2026, the package index reports advisories `PYSEC-2026-311`, `CVE-2026-45830`, `CVE-2026-45833`, and `CVE-2026-45831` for the available release, with no fixed version available to this project.
